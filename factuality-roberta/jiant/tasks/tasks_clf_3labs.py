...
# concatenation of factbank, meantime, uw, uds-ih2
@register_task("four_tasks", rel_path="four_tasks")
# concatenation of factbank, meantime, uw, uds-ih2, CB, rp, mv2
@register_task("all-factuality", rel_path="all-factuality")
@register_task("CB", rel_path="CB/CB")
@register_task("CB___split2", rel_path="CB/CB___split2")
@register_task("CB___split3", rel_path="CB/CB___split3")
# all items in CB across splits
@register_task("CB-all", rel_path="CB/CB-all")
@register_task("rp", rel_path="RP/rp")
@register_task("rp___split2", rel_path="RP/rp___split2")
@register_task("rp___split3", rel_path="RP/rp___split3")
@register_task("mv2", rel_path="MV2/mv2/")
# all items in MV2 across splits
@register_task("mv2-all", rel_path="MV2/mv2-all/")
@register_task("mv2___split2", rel_path="MV2/mv2___split2")
@register_task("mv2___split3", rel_path="MV2/mv2___split3")
@register_task("FB_clf", rel_path="FB_clf/")
@register_task("LUFB_clf", rel_path="LUFB_clf/")
@register_task("FBCB_clf", rel_path="FBCB_clf/")
@register_task("LUFBCB_clf", rel_path="LUFBCB_clf/")
@register_task("LUFBCB_Os", rel_path="LUFBCB_Os/")
@register_task("FBCB_five", rel_path="FBCB_five/")
@register_task("FB_5labs_clf", rel_path="FB_5labs_clf/")
@register_task("factbank", rel_path="FactBank/")
@register_task("meantime", rel_path="MEANTIME/")
@register_task("uw", rel_path="UW/")
@register_task("uds-ih2", rel_path="UDS_IH2/")
...
# concatenation of factbank, meantime, uw, uds-ih2, CB, rp, mv2
@register_task("all-factuality", rel_path="all-factuality/")
@register_task("LDCCB", rel_path="LDCCB/")
@register_task("CB", rel_path="CB/CB")
@register_task("CB___split2", rel_path="CB/CB___split2")
@register_task("CB___split3", rel_path="CB/CB___split3")
# all items in CB across splits
...
@register_task("mv2___split2", rel_path="MV2/mv2___split2")
@register_task("mv2___split3", rel_path="MV2/mv2___split3")
@register_task("LU", rel_path="LU/")
@register_task("LUFB", rel_path="LUFB/")
@register_task("LDCLUFB", rel_path="LDCLUFB/")
@register_task("FB_old", rel_path="FB_old/")
@register_task("FB_old_reg", rel_path="FB_old_reg/")
@register_task("DummyFB", rel_path="DummyFB/")
@register_task("FBCB_abs", rel_path="FBCB_abs/")
@register_task("factbank_shuffle", rel_path="FB_Shuffle/")
@register_task("fb_shuffle_12", rel_path="FB_Shuffle12/")
@register_task("fb_shuffle_18", rel_path="FB_Shuffle18/")
@register_task("fb_shuffle_24", rel_path="FB_Shuffle24/")
@register_task("fb_shuffle_30", rel_path="FB_Shuffle30/")
@register_task("FB_AOAS_clf", rel_path="FB_AOAS_clf/")
@register_task("FB_AOAS_pol_abs", rel_path="FB_AOAS_pol_abs")
@register_task("FB_AOAS_LU_clf", rel_path="FB_AOAS_LU_clf/")
@register_task("FB_AOAS_CB_clf", rel_path="FB_AOAS_CB_clf/")
@register_task("FB_AOAS_LU_CB_clf", rel_path="FB_AOAS_LU_CB_clf/")
@register_task("ldccb_fb", rel_path="LDCCB_FB/")
@register_task("FB_LDCCB_POL_AOAS", rel_path="FB_LDCCB_POL_AOAS/")
@register_task("FB_AOAS_POL_determiner", rel_path="FB_AOAS_POL_determiner")
@register_task("ALL_POL_det", rel_path="ALL_POL_det/")
@register_task("LU_POL_det", rel_path="LU_POL_det/")
#CLF MTL tasks
@register_task("CB_clf", rel_path="CB_clf/")
@register_task("LU_clf", rel_path="LU_clf/")
@register_task("FB_MTL_clf", rel_path="FB_MTL_clf/")
@register_task("rp_clf", rel_path="rp_clf/")
@register_task("mt_clf", rel_path="mt_clf/")
@register_task("mv_clf", rel_path="mv_clf/")
@register_task("uds_clf", rel_path="uds_clf/")
@register_task("uw_clf", rel_path="uw_clf/")
@register_task("FB_MV_clf", rel_path="FB_MV_clf/")
@register_task("FB_MT_clf", rel_path="FB_MT_clf/")
@register_task("FB_UW_clf", rel_path="FB_UW_clf/")

@register_task("FB_RP_clf", rel_path="FB_RP_clf/")
@register_task("FB_UDS_clf", rel_path="FB_UDS_clf/")
@register_task("FB_CB_MT_clf", rel_path="FB_CB_MT_clf/")
@register_task("FB_CB_MV_LU_clf", rel_path="FB_CB_MV_LU_clf/")
@register_task("FB_CB_MV_clf", rel_path="FB_CB_MV_clf/")
@register_task("ldc_clf", rel_path="ldc_clf/")
@register_task("FB_ldc_clf", rel_path="FB_ldc_clf")
@register_task("FB_tag_3", rel_path="FB_tag_3/")
@register_task("ST1", rel_path="ST1/")
...
# for average MAE
        ...
        #self.o = Average()
        #self.ct_min = Average()
        #self.pr_plus = Average()
        #self.pearson_scorer = None
        self.scorers = [self.uu, self.pr, self.ct] #self.ct_min, self.pr_plus]
    ...
    def get_metrics(self, reset=True):
        uu = self.uu.get_metric(reset)
        pr = self.pr.get_metric(reset)
        ct = self.ct.get_metric(reset)
        #o = self.o.get_metric(reset)
        #pr_plus = self.pr_plus.get_metric(reset)
        #ct_min = self.ct_min.get_metric(reset)
        macro = (uu + pr + ct )/3#+ ct_min + pr_plus) / 5
        return {"macrof1": macro, "uu": uu, "pr": pr, "ct": ct}

    def update_metrics(self, logits, labels, tagmask=None):
        # for aggregating two metrics together.
        # so that we are maximizing both pearson R and 1-MAE
        precision, recall, f1, _ = precision_recall_fscore_support(labels, logits, labels=[0,1,2], average=None)
        #self.ct_min(f1[0])
        self.pr(f1[0])
        self.uu(f1[1])
        #elf.pr_plus(f1[3])
