...
@register_task("FB_five", rel_path="FB_five/")
@register_task("FB_CB_five", rel_path="FB_CB_five/")
@register_task("FB_MT_five", rel_path="FB_MT_five/")
@register_task("FB_RP_five", rel_path="FB_RP_five/")
@register_task("FB_MV_five", rel_path="FB_MV_five/")
@register_task("FB_UDS_five", rel_path="FB_UDS_five/")
@register_task("FB_UW_five", rel_path="FB_UW_five/")
@register_task("FB_LU_five", rel_path="FB_LU_five/")

@register_task("FB_CB_LU_five", rel_path="FB_CB_LU_five/")
@register_task("FB_CB_MT_five", rel_path="FB_CB_MT_five/")
@register_task("FB_CB_MV_five", rel_path="FB_CB_MV_five/")
@register_task("FB_CB_MV_LU_five", rel_path="FB_CB_MV_LU_five/")
@register_task("LU_five", rel_path="LU_five/")

@register_task("CB_five", rel_path="CB_five/")
@register_task("UDS_five", rel_path="UDS_five/")
@register_task("RP_five", rel_path="RP_five/")
@register_task("UW_five", rel_path="UW_five/")
@register_task("MT_five", rel_path="MT_five/")
@register_task("MV_five", rel_path="MV_five/")
@register_task("FB_tag_5", rel_path="FB_tag_5/")
...
# for average MAE
    ...
    def get_metrics(self, reset=True):
        ...
        macro = (uu + pr + ct + ct_min + pr_plus) / 5
        return {"macrof1": macro, "uu": uu, "pr": pr, "ct": ct, "ct-": ct_min, "pr+": pr_plus}

    def update_metrics(self, logits, labels, tagmask=None):
        # for aggregating two metrics together.
        # so that we are maximizing both pearson R and 1-MAE
        precision, recall, f1, _ = precision_recall_fscore_support(labels, logits, labels=[0,1,2, 3, 4], average=None)
        self.ct_min(f1[0])
        self.pr(f1[1])
        self.uu(f1[2])
        self.pr_plus(f1[3])
